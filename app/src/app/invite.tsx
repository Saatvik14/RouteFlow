...
const styles = StyleSheet.create({
  ...
  brandText: { color: C.ink, fontSize: 21, fontWeight: '600', letterSpacing: -0.4 },
  ...
  eyebrow: { color: C.primaryDark, fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1 },
  title: { color: C.ink, fontSize: 27, lineHeight: 34, fontWeight: '600', letterSpacing: -0.5, marginTop: S.sm },
  ...
  metaValue: { color: C.ink, fontSize: 12, fontWeight: '600' },
  ...
  existingTitle: { color: C.ink, fontSize: 13, fontWeight: '600' },
  existingText: { color: C.inkMuted, fontSize: 11, lineHeight: 17, marginTop: 3 },
  form: { gap: S.lg },
  formTitle: { color: C.ink, fontSize: 16, fontWeight: '600' },
  ...
  stateTitle: { color: C.ink, fontSize: 23, fontWeight: '600', textAlign: 'center' },
