...
const styles = StyleSheet.create({
  ...
  summaryTitle: { color: C.primaryDark, fontSize: 13, fontWeight: '600' },
  ...
  scoreText: { color: C.success, fontSize: 12, fontWeight: '600' },
  ...
  recommended: { color: C.primaryDark, fontSize: 10, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.4 },
